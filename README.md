...
![Active Directory .jpg](https://github.com/wbj901/AD-Active-Directory-Project/blob/main/Active%20Directory%20.jpg) <br>
*Ref 1. AD Lab Diagram*
...
- Using Crowbar and Hydra for brute force attacks.<br>
...
### *-- Create a Folder*
Create a folder on your system titled: Active-Directory-Project. This is where all of your .iso files will go along with Kali Linux.
...
![image](https://github.com/user-attachments/assets/648f3888-4a14-468a-9502-f306ef273d29)

## Part 3 - Active Directory and Control Domain
### *1. Setup Active Directory Domain Services on the Windows Server*
On your Windows server, open up Server Manager. Navigate to Manage > Add Roles and Features. Select Next > Next, and check Active Directory Domain Services > Add Features. Advance until you can select install. <br><br> Once you receive the message "Configuration required. Installation succeeded on ADDC01, you can advance to the next steps. Locate the flag icon at the top of the window, and select "Promote this server to a domain controller". Select "Add a new forest", because we are creating a brand new domain. Give your domain a name, for example; 'demodomain.local'. I will call mine diplomatics.local. On the next page, leave all defaults and create a password. Advance until the Configuration Wizard validates prerequisites, and then hit install. This should trigger you to be signed out and have the server restart. <br><br> 
